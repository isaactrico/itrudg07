  ...
  return(
    <div className="Popup">
      <div className="Popup_inner text-center py-3">
        <h2 className="mb-5 mt-2" >Registrar Nuevo Empleado</h2>
        <form >
        ...
        <button className="btn btn-info mr-5 mt-3" onClick={props.handleRegUser}>Registrar</button>
        <button className="btn btn-danger mt-3" name="showRegCard" onClick={props.togglePopup}>Cancelar</button>
      </div>
    </div>
  );
}
